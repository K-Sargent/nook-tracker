...
// * Use the {@link MoneyTreeTaskFragment#newInstance} factory method to
// * create an instance of this fragment.
// */
//public class MoneyTreeTaskFragment extends Fragment {
//
...
//     * @return A new instance of fragment MoneyTreeTaskFragment.
//     */
//    // TODO: Rename and change types and number of parameters
//    public static MoneyTreeTaskFragment newInstance(String param1, String param2) {
//        MoneyTreeTaskFragment fragment = new MoneyTreeTaskFragment();
...
//        return inflater.inflate(R.layout.fragment_money_tree_task, container, false);
//    }
//}
...
import com.example.nooktracker.databinding.FragmentMoneyTreeTaskBinding;
...
public class MoneyTreeTaskFragment extends Fragment {
    ...
    private FragmentMoneyTreeTaskBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = FragmentMoneyTreeTaskBinding.inflate(inflater, container, false);
        ...
        tasksToBeUpdated.observe(getViewLifecycleOwner(), tasks -> {
            if(tasks != null){
                binding.moneyTreeCheckBox1.setChecked(tasks.moneyTreeCheckbox1);
            }
        });
    ...
    public void onPause() {
        ...
        tasksViewModel.setMoneyTreeTasks(
                tasksToBeUpdated.getValue(),
                binding.moneyTreeCheckBox1.isChecked()
        );
